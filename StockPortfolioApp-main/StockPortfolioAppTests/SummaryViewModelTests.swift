...
class SummaryViewModelTests: XCTestCase {
    ...
    override func setUp() {
        super.setUp()
        viewModel = SummaryViewModel(currentValue: 0.00, totalInvestment: 0.00, totalPNL: 0.00, todaysPNL: 0.00)
    }
    ...
    func testUpdateValues() {
        viewModel = SummaryViewModel(currentValue: 1000, totalInvestment: 800, totalPNL: 200, todaysPNL: -50)
    ...
    func testNegativeTotalPNL() {
        viewModel = SummaryViewModel(currentValue: 1000, totalInvestment: 1200, totalPNL: -200, todaysPNL: 50)
    ...
    func testZeroTotalInvestment() {
        viewModel = SummaryViewModel(currentValue: 1000, totalInvestment: 0.00, totalPNL: 200, todaysPNL: 50)
