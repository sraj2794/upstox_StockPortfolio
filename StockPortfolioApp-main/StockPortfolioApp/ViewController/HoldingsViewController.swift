...
class HoldingsViewController: UIViewController {
    private var viewModel: HoldingsViewModelType!
    ...
    init(viewModel: HoldingsViewModelType) {
    ...
    private func updateSummaryView() {
        ...
        let summaryViewModel = SummaryViewModel(currentValue: currentValue, totalInvestment: totalInvestment, totalPNL: totalPNL, todaysPNL: todaysPNL)
        summaryView.update(viewModel: summaryViewModel)
    }
}
